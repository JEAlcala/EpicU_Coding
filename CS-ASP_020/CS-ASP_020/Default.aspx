...
<body>
    ...
    <div>
        ...
        Server Control:<br />
        <br />
        <asp:TextBox ID="serverControlTextBox" runat="server" OnTextChanged="serverControlTextBox_TextChanged"></asp:TextBox>
        <br />
        <br />
        Plain of HTML Input Text Field:<br />
        <br />
        <asp:TextBox ID="plainTextBox" runat="server"></asp:TextBox>
        <br />
        <br />
