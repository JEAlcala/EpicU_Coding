...
namespace MegaWarChallenge
{
    public class Game
    {
        ...
        private string determineWinner()
        {
            ...
            result += " <br/><span style = 'color:red;font-weight:bolder;'>Player1:" + _player1.Cards.Count + "</span><span style = 'color:blue;font-weight:bolder;'>Player2:" + _player2.Cards.Count + "</span>";
            return result;
