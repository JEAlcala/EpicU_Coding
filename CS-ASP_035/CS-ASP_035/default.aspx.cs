    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void okButton_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //resultLabel.Text = String.Format("Lenght Before: {0}<br /> Length After: {1}", value.Length, value.Trim().Length);
            ...
            */
            ...
            // Replace()
            //string template = "[NAME] said it would be ok. Maybe you should take it up with [NAME].";
